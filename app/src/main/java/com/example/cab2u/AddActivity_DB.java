...
public class AddActivity_DB extends AppCompatActivity {
...
//                DBManager myDB = new DBManager(AddActivity_DB.this);
//                myDB.addHearingAid2(title_input.getText().toString().trim(),
//                        author_input.getText().toString().trim(),
//                        pages_input.getText().toString().trim(),
//                        pages_input2.getText().toString().trim(),
//                        pages_input3.getText().toString().trim(),
//                        pages_input4.getText().toString().trim(),
//                        pages_input5.getText().toString().trim(),
//                        pages_input6.getText().toString().trim(),
//                        pages_input7.getText().toString().trim());
