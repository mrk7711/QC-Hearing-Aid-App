...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new DBManager(MainActivity.this);
    ...
    void storeDataInArrays2(){
        String url = "https://mohammadreza-karimi.ir/api/read_ab.php"; // آدرس PHP
    ...
    private void deleteAllNumbersFromServer() {
        String url = "https://mohammadreza-karimi.ir/api/delete_all_numbers_ab1.php"; // آدرس فایل PHP
