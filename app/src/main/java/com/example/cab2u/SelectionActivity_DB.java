...
public class SelectionActivity_DB extends AppCompatActivity {
    private RecyclerView recyclerView;
    CustomAdapter_DB_Detail customAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selection_db);
        ...
        customAdapter = new CustomAdapter_DB_Detail(SelectionActivity_DB.this,this, book_id, book_title, book_author,
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SelectionActivity_DB.this));
        String serial = getIntent().getStringExtra("title");
        loadFilteredData(serial);
    }
    void loadFilteredData(String serial) {
        String url = "https://mohammadreza-karimi.ir/api/read_db1.php";
