...
public class SelectionActivity_DR extends AppCompatActivity {
    private RecyclerView recyclerView;
    CustomAdapter_DR_Detail customAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selection_dr);
        ...
        customAdapter = new CustomAdapter_DR_Detail(SelectionActivity_DR.this,this, book_id, book_title, book_author,
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SelectionActivity_DR.this));
        String serial = getIntent().getStringExtra("title");
        loadFilteredData(serial);
    }
    void loadFilteredData(String serial) {
        String url = "https://mohammadreza-karimi.ir/api/read_dr1.php";
