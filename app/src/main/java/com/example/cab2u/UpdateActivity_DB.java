...
public class UpdateActivity_DB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DBManager myDB = new DBManager(UpdateActivity_DB.this);
    ...
    private void deleteRecordFromServer(String id) {
        String url = "https://mohammadreza-karimi.ir/api/delete_db1.php";
    ...
    private void updateDataToServer(String id, String serial, String max_ospl90, String hfa_ospl90,
        ...
        String url = "https://mohammadreza-karimi.ir/api/update_db1.php"; // ← آدرس فایل PHP آپدیت
