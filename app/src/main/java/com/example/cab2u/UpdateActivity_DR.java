...
public class UpdateActivity_DR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_dr);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DBManager myDB = new DBManager(UpdateActivity_DR.this);
    ...
    private void deleteRecordFromServer(String id) {
        String url = "https://mohammadreza-karimi.ir/api/delete_dr1.php";
    ...
    private void updateDataToServer(String id, String serial, String max_ospl90, String hfa_ospl90,
        ...
        String url = "https://mohammadreza-karimi.ir/api/update_dr1.php"; // ← آدرس فایل PHP آپدیت
